...
CASE=20210824 
EXP_NAME=CON6h_Aeolus6h_L2B_Hybrid_082512 
ANAL_TIME=2021082512 
DOMAIN_NAME=d01 
...
DATA_DIR=/uufs/chpc.utah.edu/common/home/zpu-group16/cfeng/03_CPEX_DAWN/08_CPEX_AW_2021/run_wrf
RUN_DIR=${DATA_DIR}/${CASE}_${EXP_NAME}

#normally you put run scripts here and submit jobs form here, require a copy of gsi.x at this directory
OPTION_ROOT=${DATA_DIR}/namelist_and_script/${CASE}
OBS_ROOT=${RUN_DIR}/${ANAL_TIME}/obs
PREPBUFR=${OBS_ROOT}/prepbufr.gdas.${YY}${MM}${DD}.t${HH}z.nr.48h
BK_ROOT=${RUN_DIR}/${ANAL_TIME}/bkg
BK_FILE=${BK_ROOT}/wrfout_${DOMAIN_NAME}_${YY}-${MM}-${DD}_${HH}:00:00
WRFINPUT_ROOT=${RUN_DIR}/${ANAL_TIME}/wrfinput
#ENS_ROOT is not required if not running hybrid EnVAR 
ENS_ROOT=${RUN_DIR}/${ANAL_TIME}/gfsens
...
if_ncio=Yes      # Yes, or, No -- case sensitive !
...
elif [ ${if_ncio} = Yes ]; then 
if_gfs_nemsio='.false.'
if_gfs_ncio='.true.'
ENSEMBLE_FILE_mem=${ENS_ROOT}/gdas.t*z.atmf006s.mem
else
if_gfs_nemsio='.false.'
if_gfs_ncio='.false.'
...
ENSEMBLE_FILE_mem_p1=${ENS_ROOT}/gdas.t*z.atmf009s.mem
ENSEMBLE_FILE_mem_m1=${ENS_ROOT}/gdas.t*z.atmf003s.mem
else
...
srcobsfile[25]=${OBS_ROOT}/gdas.t${HH}z.aeolus.tm00.bufr_d
gsiobsfile[25]=aeolusbufr
srcobsfile[26]=${OBS_ROOT}/gdas.t${HH}z.dawn.tm00.bufr_d
gsiobsfile[26]=hdobbufr
srcobsfile[27]=${OBS_ROOT}/gdas.t${HH}z.halo.tm00.bufr_d
gsiobsfile[27]=halobufr
srcobsfile[28]=${OBS_ROOT}/gdas.t${HH}z.dropsonde.tm00.bufr_d
gsiobsfile[28]=dsbufr
ii=1
while [[ $ii -le 28 ]]; do
...
OBERROR=${OPTION_ROOT}/prepobs_errtable.global
if [ ${bk_core} = NMM ] ; then
...
CONVINFO=${OPTION_ROOT}/global_convinfo.txt
