...
case = '20210824_CON6h_Aeolus6h_L2B_Hybrid_082500'
...
#case = '20210824_CON6h_Aeolus6h_L2B_Hybrid_082512'
...
if '20210904' in case:
    ...
    assimilate_hours  = 24
    forecast_hours    = 48
    initial_time      = datetime.datetime(2021, 9,  4, 12, 0, 0)
...
while time_now <= anl_end_time:
    ...
    if time_now >= flight_start_time and time_now < flight_end_time:
        (history_interval, cycling_interval) = (60, 1)
    else:
        (history_interval, cycling_interval) = (360, 6)
    if time_now == anl_end_time and ('20210820' in case or '20210821' in case):
        history_interval = 60
    if time_now > flight_start_time and time_now <= flight_start_time + datetime.timedelta(hours = 3.0):
        ens_time = flight_start_time - datetime.timedelta(hours = 6.0)
    elif time_now > flight_start_time + datetime.timedelta(hours = 3.0) and time_now <= flight_end_time:
