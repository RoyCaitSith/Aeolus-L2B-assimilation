...
for dom in domains:
    for idc, case in enumerate(cases):
        ...
        filename = dir_main + '/' + case[9:] + '/' + var + '_da_' + dom + '.nc'
        ...
        for idt in range(0, n_time):
            ...
            pdfname = dir_pdf + '/' + case[9:] + '/' + var + '_da_' + dom + '_' + time_now_str + '.pdf'
            ...
            with PdfPages(pdfname) as pdf:
                ...
                for lev in levels.keys():
                    ...
                    for ids, sta in enumerate(status):
                        ...
                        m.drawparallels(np.arange(int(extent[2]), int(extent[3])+5, 10.0), labels=[1,0,0,0], fontsize=10.0, linewidth=0.5)
                        m.drawmeridians(np.arange(int(extent[0]), int(extent[1])+1, 10.0), labels=[0,0,0,1], fontsize=10.0, linewidth=0.5)
                        ...
                        mtitle = '(' + chr(97+idc) + str(ids+1) + ') ' + case[9:] + ', ' + sta
