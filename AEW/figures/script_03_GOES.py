...
for case in cases:
    ...
    for (idt, time_now) in enumerate(draw_times):
        ...
        pdfname = '_'.join([case, time_now_str, 'GOES.pdf'])
        print(pdfname)
        ...
        with PdfPages(pdfname) as pdf:
            ...
            clb_label = 'GOES-R Channel 8 Brightness Temperatures (K)'
            clb = fig.colorbar(pcm, ax=ax, ticks=np.arange(190, 250.1, 10.0), orientation='horizontal', pad=0.035, aspect=50, shrink=1.00)
