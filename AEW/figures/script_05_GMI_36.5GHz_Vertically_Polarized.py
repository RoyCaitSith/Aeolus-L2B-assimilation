...
for case in cases:
    ...
    for (idt, time_now) in enumerate(draw_times):
        ...
        pdfname = '_'.join([case, time_now_str, 'GMI_36.5GHz_Vertically_Polarized.pdf'])
        print(pdfname)
        ...
        with PdfPages(pdfname) as pdf:
            ...
            clb_label = 'GMI 36.5 GHz V Brightness Temperatures (K)'
            clb = fig.colorbar(pcm, ax=ax, ticks=np.arange(175, 205.1, 5), orientation='horizontal', pad=0.035, aspect=50, shrink=1.00)
