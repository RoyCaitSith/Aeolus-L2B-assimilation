...
anl_start_time = datetime.datetime(2021, 8, 24,  0, 0, 0, tzinfo = datetime.timezone.utc)
anl_end_time   = datetime.datetime(2021, 8, 26,  0, 0, 0, tzinfo = datetime.timezone.utc)
time_interval  = 6
