...
for dom in domains:
    ...
    with PdfPages(pdfname) as pdf:
        for idt in range(0, n_time):
            ...
            suptitle_str = time_now_str + ', ' + dom + ', v'
            ...
            for idl, lev in enumerate(level[0:3]):
                ...
                pcm = ax.contourf(lon, lat, va[idt,idl,:,:], levels=np.arange(-4.5, 5.0, 1.0), cmap='RdBu_r', extend='both', zorder=0)
