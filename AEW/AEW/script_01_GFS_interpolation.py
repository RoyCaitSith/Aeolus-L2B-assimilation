...
if '20210824' in time:
    start_time = datetime.datetime(2021, 8, 23, 18, 0, 0)
    end_time   = datetime.datetime(2021, 8, 28, 18, 0, 0)
if '20210828' in time:
    start_time = datetime.datetime(2021, 8, 28, 12, 0, 0)
    end_time   = datetime.datetime(2021, 8, 31,  6, 0, 0)
if '20210904' in time:
    start_time = datetime.datetime(2021, 9,  3, 18, 0, 0)
    end_time   = datetime.datetime(2021, 9,  7,  6, 0, 0)
...
variables = {}
variables.update({'ua':      [[925, 850, 700, 600, 500, 300, 200], 'ms-1', 'UGRD_P0_L100_GLL0']})
...
for dom in domains:
    for case in cases:
        for var in variables.keys():
            ...
            dir_wrfout = '/'.join([dir_CPEX, 'bkg', time, 'CON6h'])
