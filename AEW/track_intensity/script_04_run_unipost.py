...
dir_exp = '/uufs/chpc.utah.edu/common/home/zpu-group16/cfeng/03_CPEX_DAWN/08_CPEX_AW_2021/track_intensity'
#folder_in  = dir_exp + '/' + time + '/CON6h_Hybrid_082500'
folder_in  = dir_exp + '/' + time + '/CON6h_Hybrid_082512'
folder_out = dir_exp + '/' + time + '/' + case
