...
cat <<EOF > gsiparm.anl
 ...
 /
 &OBS_INPUT
   dmesh(1)=120.0,dmesh(2)=60.0,dmesh(3)=30,dmesh(4)=30,time_window_max=3.0,ext_sonde=.true.,
 /
OBS_INPUT::
!  dfile          dtype       dplat     dsis                 dval    dthin dsfcalc
   ...
   aeolusbufr     dw          aladin    dw_aladin            1.0     0     0
   hdobbufr       uv          dawn      uv_dawn              1.0     0     0
   halobufr       q           halo      q_halo               1.0     0     0
   dsbufr         uv          ds        uv_ds                1.0     0     0
   dsbufr         t           ds        t_ds                 1.0     0     0
   dsbufr         q           ds        q_ds                 1.0     0     0
::
 &SUPEROB_RADAR
 ...
 &HYBRID_ENSEMBLE
   ...
   n_ens=${nummem},
   beta_s0=0.2,s_ens_h=110,s_ens_v=1.5,
