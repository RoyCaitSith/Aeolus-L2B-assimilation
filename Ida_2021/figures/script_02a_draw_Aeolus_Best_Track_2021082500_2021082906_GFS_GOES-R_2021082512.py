...
file_wrfout_d01 = dir_wrfout + '/wrfout_d01_2021-08-25_00:00:00'
file_wrfout_d02 = dir_wrfout + '/wrfout_d02_2021-08-25_00:00:00'
...
#Best track data from 2021082500 to 2021082906
(sidx, eidx, zidx) = (3, 21, 0)
...
pdfname = '_'.join(['Figure_02a_2021082500_2021082906_GFS_GOES-R_2021082512.pdf'])
...
with PdfPages(pdfname) as pdf:
    ...
    time_now = datetime.datetime(2021, 8, 25, 12, 0, 0)
