...
for dom in domains:
    ...
    with PdfPages(pdfname) as pdf:
        ...
        fig.subplots_adjust(left=0.050, bottom=-0.050, right=0.975, top=0.950, wspace=0.125, hspace=0.250)
        ...
        for idc, (case0, case1) in enumerate(zip(cases0, cases1)):
            ...
            if os.path.exists(bufrname):
                ...
                ua_bkg_0 = getvar(ncfile_bkg_0, 'ua', units='ms-1')
                temp_bkg_0 = vertcross(ua_bkg_0, ht_bkg_0, wrfin=ncfile_bkg_0, levels=level*1000.0, start_point=start_point, end_point=end_point, latlon=True, meta=True)
                ncfile_bkg_0.close()
                ...
                ua_anl_0 = getvar(ncfile_anl_0, 'ua', units='ms-1')
                temp_anl_0 = vertcross(ua_anl_0, ht_anl_0, wrfin=ncfile_anl_0, levels=level*1000.0, start_point=start_point, end_point=end_point, latlon=True, meta=True)
                ncfile_anl_0.close()
                ...
                ax = axs[idc, 0]
                inc_0_contourf = ax.contourf(lat_2d, level_2d, inc_0_2d, levels=np.arange(-10.0, 10.1, 2.0), cmap=vik_map, extend='both', zorder=1)
                bkg_0_contour1 = ax.contour (lat_2d, level_2d, bkg_0_2d, levels=np.arange(-99.0, -1.5, 6.0), linestyles='dashed', colors='k', linewidths=1.0, zorder=2)
                bkg_0_contour2 = ax.contour (lat_2d, level_2d, bkg_0_2d, levels=np.arange(  3.0, 94.5, 6.0), linestyles='solid',  colors='k', linewidths=1.0, zorder=2)
                plt.clabel(bkg_0_contour1, bkg_0_contour1.levels[0::2], fontsize=7.5, inline=1, fmt='%1.0f')
                plt.clabel(bkg_0_contour2, bkg_0_contour2.levels[0::2], fontsize=7.5, inline=1, fmt='%1.0f')
                ...
                ua_bkg_1 = getvar(ncfile_bkg_1, 'ua', units='ms-1')
                temp_bkg_1 = vertcross(ua_bkg_1, ht_bkg_1, wrfin=ncfile_bkg_1, levels=level*1000.0, start_point=start_point, end_point=end_point, latlon=True, meta=True)
                ncfile_bkg_1.close()
                ...
                ua_anl_1 = getvar(ncfile_anl_1, 'ua', units='ms-1')
                temp_anl_1 = vertcross(ua_anl_1, ht_anl_1, wrfin=ncfile_anl_1, levels=level*1000.0, start_point=start_point, end_point=end_point, latlon=True, meta=True)
                ncfile_anl_1.close()
                ...
                ax = axs[idc, 1]
                inc_1_contourf = ax.contourf(lat_2d, level_2d, inc_1_2d, levels=np.arange(-10.0, 10.1, 2.0), cmap=vik_map, extend='both', zorder=1)
                bkg_1_contour1 = ax.contour (lat_2d, level_2d, bkg_1_2d, levels=np.arange(-99.0, -1.5, 6.0), linestyles='dashed', colors='k', linewidths=1.0, zorder=2)
                bkg_1_contour2 = ax.contour (lat_2d, level_2d, bkg_1_2d, levels=np.arange(  3.0, 94.5, 6.0), linestyles='solid',  colors='k', linewidths=1.0, zorder=2)
                plt.clabel(bkg_1_contour1, bkg_1_contour1.levels[0::2], fontsize=7.5, inline=1, fmt='%1.0f')
                plt.clabel(bkg_1_contour2, bkg_1_contour2.levels[0::2], fontsize=7.5, inline=1, fmt='%1.0f')
                ax.plot(TC_lat[0], 0.0, '^', color='k', ms=10.0)
                ...
                ax = axs[idc, 2]
                inc_diff_contourf = ax.contourf(lat_2d, level_2d, inc_1_2d-inc_0_2d, levels=np.arange(-10.0, 10.1, 2.0), cmap=vik_map, extend='both', zorder=1)
                #bkg_diff_contour1 = ax.contour (lat_2d, level_2d, bkg_1_2d-bkg_0_2d, levels=np.arange(-33.0, -0.5, 2.0), linestyles='dashed', colors='k', linewidths=1.0, zorder=2)
                #bkg_diff_contour2 = ax.contour (lat_2d, level_2d, bkg_1_2d-bkg_0_2d, levels=np.arange(  1.0, 31.5, 2.0), linestyles='solid',  colors='k', linewidths=1.0, zorder=2)
                #plt.clabel(bkg_diff_contour1, bkg_diff_contour1.levels[0::2], fontsize=7.5, inline=1, fmt='%1.0f')
                #plt.clabel(bkg_diff_contour2, bkg_diff_contour2.levels[0::2], fontsize=7.5, inline=1, fmt='%1.0f')
                ax.plot(TC_lat[0], 0.0, '^', color='k', ms=10.0)
        ...
        clb2.set_label('Difference of increment ($\mathrm{m\ s^{-1}}$)', fontsize=10.0, labelpad=4.0)
