...
extents = [[-91.5, -76.5, 13.0, 28.0], [-91.5, -76.5, 13.0, 28.0], [-91.5, -76.5, 13.0, 28.0], [-91.5, -76.5, 13.0, 28.0]]
...
start_times = ['06 UTC 26 Aug', '06 UTC 26 Aug', '06 UTC 26 Aug', '06 UTC 26 Aug']
end_times = ['00 UTC 29 Aug', '00 UTC 29 Aug', '00 UTC 29 Aug', '00 UTC 29 Aug']

mtitle1 = ['(a)', '(b)', '(c)', '(d)']
mtitle1_lons = [-91.25, -91.25, -91.25, -91.25]
mtitle1_lats = [27.0, 27.0, 27.0, 27.0]
mtitle2 = ['(e)', '(f)', '(g)', '(h)']
