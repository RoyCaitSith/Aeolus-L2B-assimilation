    ...
    for idc, case in enumerate(cases):
        ...
        for idc, time_now in enumerate(draw_times):
            ...
            if os.path.exists(bufrname):
                ...
                pdfname = '_'.join([time_now_str, 'va', case, dom+'.pdf'])
                ...
                with PdfPages(pdfname) as pdf:
                    ...
                    temp_bkg = vertcross(va_bkg, ht_bkg, wrfin=ncfile_bkg, levels=level*1000.0, start_point=start_point, end_point=end_point, latlon=True, meta=True)
                    ncfile_bkg.close()
                    ...
                    temp_anl = vertcross(va_anl, ht_anl, wrfin=ncfile_anl, levels=level*1000.0, start_point=start_point, end_point=end_point, latlon=True, meta=True)
                    ncfile_anl.close()
                    ...
                    clb.set_label('Meridional Wind Increment (m/s) of Exp. ' + label + \
