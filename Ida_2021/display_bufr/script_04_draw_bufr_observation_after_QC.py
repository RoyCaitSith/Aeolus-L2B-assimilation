    ...
    for idt, time_now in enumerate(draw_times):
        ...
        for stat in status:
            ...
            if os.path.exists(filename):
                ...
                pdfname = dir_out + '/Observation_After_QC_' + time_now_str + '_' + stat + '_' + dom + '.pdf'
                with PdfPages(pdfname) as pdf:
                    ...
                    ax = axs[0]
                    pcm = ax.scatter(latitude[mie_index_analysis], height[mie_index_analysis], c=observation[mie_index_analysis], \
                    ...
                    ax = axs[1]
                    pcm = ax.scatter(latitude[rayleigh_index_analysis], height[rayleigh_index_analysis], c=observation[rayleigh_index_analysis], \
                                     marker='|', s=25.0, vmin=-40.0, vmax=40.0, cmap='RdYlBu_r', zorder=0)
