    ...
    for idt, time_now in enumerate(draw_times):
        ...
        for stat in status:
            ...
            if os.path.exists(filename):
                ...
                pdfname = dir_out + '/Normalized_OmB_After_QC_' + time_now_str + '_' + stat + '_' + dom + '.pdf'
                with PdfPages(pdfname) as pdf:
                    ...
                    ax = axs[0]
                    pcm = ax.scatter(latitude[mie_index_analysis], height[mie_index_analysis], c=normalized_OmB[mie_index_analysis], \
                                     marker='|', s=25.0, vmin=-3.0, vmax=3.0, cmap='RdBu_r', zorder=0)
                    ...
                    ax = axs[1]
                    pcm = ax.scatter(latitude[rayleigh_index_analysis], height[rayleigh_index_analysis], c=normalized_OmB[rayleigh_index_analysis], \
                                     marker='|', s=25.0, vmin=-3.0, vmax=3.0, cmap='RdBu_r', zorder=0)
                    ...
                    clb = fig.colorbar(pcm, ax=axs, ticks=np.arange(-3.0, 3.0, 0.5), orientation='horizontal', pad=0.100, aspect=37.5, shrink=1.00)
                    clb.set_label('Normalized OmB (m/s)', fontsize=10.0, labelpad=4.0)
