    ...
    for idt, time_now in enumerate(draw_times):
        ...
        for stat in status:
            ...
            if os.path.exists(filename):
                ...
                pdfname = dir_out + '/Observation_Error_Final_After_QC_' + time_now_str + '_' + stat + '_' + dom + '.pdf'
                with PdfPages(pdfname) as pdf:
                    ...
                    ax = axs[0]
                    pcm = ax.scatter(latitude[mie_index_analysis], height[mie_index_analysis], c=1.0/inverse_obs_error_final[mie_index_analysis], \
                    ...
                    ax = axs[1]
                    pcm = ax.scatter(latitude[rayleigh_index_analysis], height[rayleigh_index_analysis], c=1.0/inverse_obs_error_final[rayleigh_index_analysis], \
                                     marker='|', s=25.0, vmin=0.0, vmax=5.0, cmap='gist_rainbow', zorder=0)
                    ...
                    clb.set_label('Observation Error Final (m/s)', fontsize=10.0, labelpad=4.0)
