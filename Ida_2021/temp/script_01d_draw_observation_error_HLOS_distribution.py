...
for dom in domains:
    for stat in status:
        for case in cases:
            ...
            pdfname = './Figure_01d_Observation_Error_HLOS_Distribution_' + stat + '_' + dom + '.pdf'
            ...
            with PdfPages(pdfname) as pdf:
                ...
                ax.plot([-1000, 1000], [2.5, 2.5], '-', color=sns_paired[5])
                ...
                ax.plot([-1000, 1000], [4.5, 4.5], '-', color=sns_paired[5])
