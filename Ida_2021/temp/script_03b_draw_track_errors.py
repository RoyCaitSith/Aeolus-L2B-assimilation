...
domain = 'd01'
variables = {}
variables.update({'Track_Error (km)': [-75, 75, 25]})

#pdfname = './Figure_03b_Comparison_track_082406.pdf'
#pdfname = './Figure_03d_Comparison_track_082412.pdf'
#pdfname = './Figure_03f_Comparison_track_082418.pdf'
pdfname = './Figure_03h_Comparison_track_082500.pdf'
...
with PdfPages(pdfname) as pdf:
    for var in variables:
        ...
        ax.set_ylabel('Improvement of 48-h Track Forecast (km)', fontsize=10.0)
