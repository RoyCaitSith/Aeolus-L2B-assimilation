...
#Read GFS hgt and rh at 2021082412
GFS_time = 1
...
#Best track data from 2021082406 to 2021082812
(sidx, eidx, zidx) = (0, 18, 0)
...
pdfname = '_'.join(['Figure_02a_2021082406_2021082812_GFS_GOES-R_2021082412.pdf'])
...
with PdfPages(pdfname) as pdf:
    ...
    time_GOES_now = datetime.datetime(2021, 8, 24, 12, 0, 0)
