...
anl_start_time = datetime.datetime(2021, 8, 25, 12, 0, 0)
...
colors = [sns_cmap[5], sns_cmap[7], sns_cmap[9], sns_cmap[11]]
...
#Read GFS hgt and rh at 2021082712
GFS_time = 10
...
pdfname = '_'.join(['Figure_02d_2021082500_2021082906_GFS_GOES-R_2021082712.pdf'])
...
with PdfPages(pdfname) as pdf:
    ...
    time_GOES_now = datetime.datetime(2021, 8, 27, 12, 0, 0)
