...
file_wrfout_d01 = dir_wrfout + '/wrfout_d01_2021-08-24_18:00:00'
file_wrfout_d02 = dir_wrfout + '/wrfout_d02_2021-08-24_18:00:00'
...
#Read GFS hgt and rh at 2021082612
GFS_time = 7
...
#Best track data from 2021082418 to 2021082900
(sidx, eidx, zidx) = (2, 20, 0)
...
pdfname = '_'.join(['Figure_02c_2021082418_2021082900_GFS_GOES-R_2021082612.pdf'])
...
with PdfPages(pdfname) as pdf:
    ...
    time_GOES_now = datetime.datetime(2021, 8, 26, 12, 0, 0)
